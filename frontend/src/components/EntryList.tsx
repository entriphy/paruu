      ...
      <Accordion>
        ...
        >
          <div style={{ flexDirection: "column" }}>
            <Typography>{e.name !== null ? e.name : `func_${e.address.toString(16).padStart(8, "0").toUpperCase()}`}{(e.dc_progress === 100.0 || e.ez) ? " ✔" : ""}</Typography>
            <Typography variant="caption">0x{e.address.toString(16).padStart(8, "0").toUpperCase()}</Typography>
          </div>
        </AccordionSummary>
        <AccordionDetails>
